...
@app.on_message(filters.command(["tagall", "ازعجههههم", "tagmember", "utag", "stag", "hftag", "bstag", "eftag", "tag", "etag", "utag", "atag" ], prefixes=["/", "@", ""]))
...
@app.on_message(filters.command(["تووقف", "ق تاك" ], prefixes=["/", "@", ""]))
